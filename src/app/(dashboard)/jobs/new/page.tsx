  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
      <div className="container mx-auto p-6">
        ...
        {/* Main Form Card */}
        <Card className="mx-auto max-w-4xl border-0 bg-white/95 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-xl text-slate-800">
              Job Requirements
            </CardTitle>
            <CardDescription>
              Provide details about the role you want to fill
            </CardDescription>
          </CardHeader>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onKeyPress={(e) => {
                        if (e.key === "Enter" && skillInput.trim()) {
                          e.preventDefault();
                          addSkill(skillInput.trim(), "niceToHave");
                        }
                      }}
                      className="border-slate-200 bg-slate-50"
                    />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800">
                          The more specific you are about your requirements, the
                          better our AI can match you with the right candidates.
                          Include both technical skills and soft skills you
                          value.
                        </p>
                      </div>
                    </div>
